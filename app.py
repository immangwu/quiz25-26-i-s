...
# =====================================================================================
# --- 🔬 NDT QUESTION BANK - QUIZ 04 (Radiography) ---
# =====================================================================================

NDT_QUIZ04_QUESTION_BANK = [
    {"id": 1, "question": "What does the term 'radiography' primarily refer to?",
     "options": ["Using sound waves to create images", "Using X-rays or gamma rays to create images of the interior of objects", "Using magnetic fields to visualise soft tissue", "Using light waves to photograph surfaces"],
     "correct": 1, "co": "CO5"},
    {"id": 2, "question": "Who discovered X-rays in 1895?",
     "options": ["Marie Curie", "Henri Becquerel", "Wilhelm Conrad Röntgen", "Nikola Tesla"],
     "correct": 2, "co": "CO5"},
    {"id": 3, "question": "Which of the following is NOT a common application of radiography?",
     "options": ["Medical diagnosis", "Non-destructive testing of welds", "Astronomical observation", "Baggage screening at airports"],
     "correct": 2, "co": "CO5"},
    {"id": 4, "question": "The SI unit of radiation absorbed dose is the:",
     "options": ["Curie", "Roentgen", "Gray", "Becquerel"],
     "correct": 2, "co": "CO5"},
    {"id": 5, "question": "X-rays are part of which region of the electromagnetic spectrum?",
     "options": ["Radio waves", "Infrared", "Visible light", "Ionising electromagnetic radiation"],
     "correct": 3, "co": "CO5"},
    {"id": 6, "question": "The basic principle of radiography imaging relies on differences in:",
     "options": ["Colour absorption of tissues", "Density and atomic number of materials affecting radiation attenuation", "Sound impedance of soft tissues", "Temperature gradients across structures"],
     "correct": 1, "co": "CO5"},
    {"id": 7, "question": "In medical radiography, bones appear white on a film because they:",
     "options": ["Emit their own radiation", "Absorb more X-rays than soft tissue", "Reflect X-rays back to the detector", "Fluoresce under X-ray exposure"],
     "correct": 1, "co": "CO5"},
    {"id": 8, "question": "The process by which an atom loses an electron due to radiation is called:",
     "options": ["Excitation", "Ionisation", "Fluorescence", "Pair production"],
     "correct": 1, "co": "CO5"},
    {"id": 9, "question": "In an X-ray tube, X-rays are produced when high-speed electrons strike the:",
     "options": ["Cathode filament", "Anode (target)", "Glass envelope", "Focusing cup"],
     "correct": 1, "co": "CO5"},
    {"id": 10, "question": "What percentage of electron kinetic energy is converted to X-rays in a typical X-ray tube?",
     "options": ["Less than 1%", "Approximately 1%", "About 50%", "Around 99%"],
     "correct": 1, "co": "CO5"},
    {"id": 11, "question": "Characteristic X-rays are produced when:",
     "options": ["Electrons decelerate near the nucleus", "An outer-shell electron fills a vacancy in an inner shell", "Electrons are reflected off the target", "The tube current exceeds the maximum rating"],
     "correct": 1, "co": "CO5"},
    {"id": 12, "question": "Bremsstrahlung radiation ('braking radiation') results from:",
     "options": ["Electron–electron repulsion", "Deceleration of electrons in the coulomb field of the nucleus", "Radioactive decay of the anode", "Thermal emission from the filament"],
     "correct": 1, "co": "CO5"},
    {"id": 13, "question": "Increasing the kVp (kilovoltage peak) primarily affects:",
     "options": ["The number of X-rays produced", "The maximum energy (penetrating power) of the X-rays", "The focal spot size", "The exposure time"],
     "correct": 1, "co": "CO5"},
    {"id": 14, "question": "Which of the following is a common gamma-ray source used in industrial radiography?",
     "options": ["Technetium-99m", "Iridium-192", "Fluorine-18", "Xenon-133"],
     "correct": 1, "co": "CO5"},
    {"id": 15, "question": "The half-life of Iridium-192 used in industrial radiography is approximately:",
     "options": ["14 days", "74 days", "5.3 years", "30 years"],
     "correct": 1, "co": "CO5"},
    {"id": 16, "question": "Cobalt-60 is preferred over Ir-192 for radiographing very thick sections because it emits:",
     "options": ["Lower energy gamma rays", "Higher energy gamma rays", "Alpha particles", "Beta particles only"],
     "correct": 1, "co": "CO5"},
    {"id": 17, "question": "The activity of a radioactive source is measured in:",
     "options": ["Gray (Gy)", "Sievert (Sv)", "Becquerel (Bq)", "Röntgen (R)"],
     "correct": 2, "co": "CO5"},
    {"id": 18, "question": "The anode (target) of a diagnostic X-ray tube is most commonly made of:",
     "options": ["Copper", "Aluminium", "Tungsten", "Lead"],
     "correct": 2, "co": "CO5"},
    {"id": 19, "question": "The X-ray tube envelope is typically made of:",
     "options": ["Lead glass", "Borosilicate or Pyrex glass", "Steel", "Aluminium alloy"],
     "correct": 1, "co": "CO5"},
    {"id": 20, "question": "The cathode filament of an X-ray tube is made of:",
     "options": ["Molybdenum", "Tungsten", "Copper", "Platinum"],
     "correct": 1, "co": "CO5"},
    {"id": 21, "question": "The 'focal spot' of an X-ray tube refers to:",
     "options": ["The area of the film that receives the primary beam", "The area on the anode where electrons strike and X-rays are produced", "The window through which X-rays exit the tube", "The centre of the X-ray beam at the patient"],
     "correct": 1, "co": "CO5"},
    {"id": 22, "question": "The 'line focus principle' in X-ray tubes is used to:",
     "options": ["Increase beam intensity at the film", "Achieve a small effective focal spot while distributing heat over a larger actual area", "Reduce patient dose", "Align the X-ray beam with the grid"],
     "correct": 1, "co": "CO5"},
    {"id": 23, "question": "The mA (milliamperes) setting in an X-ray tube controls:",
     "options": ["Beam energy", "Number of electrons (and therefore X-ray photons) produced per second", "Focal spot temperature", "Filter thickness"],
     "correct": 1, "co": "CO5"},
    {"id": 24, "question": "Rotating anode X-ray tubes are used to:",
     "options": ["Produce harder X-rays", "Spread heat over a larger target area allowing higher power outputs", "Reduce electrical noise", "Decrease the effective focal spot size"],
     "correct": 1, "co": "CO5"},
    {"id": 25, "question": "Which interaction dominates at low photon energies (< 30 keV) in soft tissue?",
     "options": ["Pair production", "Compton scattering", "Photoelectric effect", "Coherent scattering"],
     "correct": 2, "co": "CO5"},
    {"id": 26, "question": "Compton scattering involves:",
     "options": ["Complete absorption of the photon by an inner-shell electron", "Partial absorption: the photon ejects an outer-shell electron and a scattered photon of lower energy is produced", "Production of an electron–positron pair", "Coherent scattering without energy loss"],
     "correct": 1, "co": "CO5"},
    {"id": 27, "question": "Pair production requires a minimum photon energy of:",
     "options": ["0.511 MeV", "1.022 MeV", "10 MeV", "0.1 MeV"],
     "correct": 1, "co": "CO5"},
    {"id": 28, "question": "The Beer-Lambert law in radiography describes:",
     "options": ["The relationship between temperature and X-ray output", "The exponential attenuation of X-rays as they pass through matter", "The speed of X-rays in different media", "The energy spectrum of the X-ray beam"],
     "correct": 1, "co": "CO5"},
    {"id": 29, "question": "Radiographic image contrast is primarily determined by:",
     "options": ["Differences in X-ray attenuation between adjacent structures", "The speed of the film used", "The distance from the X-ray source to the film", "The colour of the intensifying screen"],
     "correct": 0, "co": "CO5"},
    {"id": 30, "question": "Geometric unsharpness (penumbra) in a radiographic image is minimised by:",
     "options": ["Using a large focal spot", "Increasing the source-to-object distance and decreasing the object-to-film distance", "Using a thicker filter", "Increasing tube current"],
     "correct": 1, "co": "CO5"},
    {"id": 31, "question": "Radiographic film emulsion contains which silver compound?",
     "options": ["Silver nitrate", "Silver bromide", "Silver iodide", "Silver chloride"],
     "correct": 1, "co": "CO5"},
    {"id": 32, "question": "The latent image on radiographic film is formed by:",
     "options": ["Visible light exposure alone", "Reduction of silver ions to metallic silver atoms at sensitivity specks", "Oxidation of the gelatin layer", "Direct chemical change of the base material"],
     "correct": 1, "co": "CO5"},
    {"id": 33, "question": "In film processing, the developer solution functions to:",
     "options": ["Fix the image by removing unexposed silver bromide", "Amplify the latent image by chemically reducing exposed silver halide grains to metallic silver", "Harden the gelatin", "Stop the development process"],
     "correct": 1, "co": "CO5"},
    {"id": 34, "question": "The fixer solution in film processing removes:",
     "options": ["Developed silver from the film", "Unexposed and undeveloped silver halide crystals", "Water from the emulsion", "The base anti-halation layer"],
     "correct": 1, "co": "CO5"},
    {"id": 35, "question": "Film speed in radiography refers to:",
     "options": ["How quickly the film can be transported through the processor", "The sensitivity of the film to radiation", "The thickness of the base material", "The density range the film can record"],
     "correct": 1, "co": "CO5"},
    {"id": 36, "question": "Which of the following is a filmless radiography technique?",
     "options": ["Direct radiography (DR)", "Wet-film processing", "Silver halide photography", "Contact radiography"],
     "correct": 0, "co": "CO5"},
    {"id": 37, "question": "Computed Radiography (CR) uses which medium to capture the latent image?",
     "options": ["Flat-panel amorphous silicon detector", "Photostimulable phosphor (PSP) plate", "CCD (charge-coupled device)", "Standard intensifying screen + film"],
     "correct": 1, "co": "CO5"},
    {"id": 38, "question": "A key advantage of filmless digital radiography over conventional film is:",
     "options": ["Higher initial equipment cost", "Post-processing image manipulation and rapid image availability", "Better spatial resolution in all situations", "No radiation dose to the patient"],
     "correct": 1, "co": "CO5"},
    {"id": 39, "question": "Intensifying screens in film radiography serve to:",
     "options": ["Increase the radiation dose", "Convert X-rays into visible light, amplifying the film's response and reducing patient dose", "Improve geometric sharpness", "Filter out low-energy photons before they reach the patient"],
     "correct": 1, "co": "CO5"},
    {"id": 40, "question": "Aluminium filters are placed in the X-ray beam primarily to:",
     "options": ["Increase beam intensity", "Harden the beam by removing low-energy photons that contribute to dose but not image quality", "Collimate the beam to the region of interest", "Reduce the tube voltage"],
     "correct": 1, "co": "CO5"},
    {"id": 41, "question": "A wedge filter (compensating filter) is used to:",
     "options": ["Reduce radiation exposure to the operator", "Equalise image density over body parts of varying thickness", "Increase the energy of the beam", "Remove scatter radiation before it reaches the film"],
     "correct": 1, "co": "CO5"},
    {"id": 42, "question": "An anti-scatter grid is placed between the patient and the film to:",
     "options": ["Reduce geometric unsharpness", "Absorb scattered radiation while allowing primary beam photons to pass", "Increase image magnification", "Provide added beam filtration"],
     "correct": 1, "co": "CO5"},
    {"id": 43, "question": "Fluoroscopy differs from conventional radiography in that it:",
     "options": ["Uses ultrasound instead of X-rays", "Provides real-time continuous X-ray imaging", "Uses only gamma rays", "Requires general anaesthesia"],
     "correct": 1, "co": "CO5"},
    {"id": 44, "question": "An image intensifier in fluoroscopy is used to:",
     "options": ["Amplify and convert the X-ray image to a bright visible image, reducing patient dose", "Collimate the X-ray beam", "Filter low-energy radiation", "Record the image on photographic film"],
     "correct": 0, "co": "CO5"},
    {"id": 45, "question": "Xeroradiography uses which medium to record the latent image?",
     "options": ["Silver bromide film", "A selenium-coated aluminium plate", "Photostimulable phosphor", "A flat-panel amorphous silicon detector"],
     "correct": 1, "co": "CO5"},
    {"id": 46, "question": "Xeroradiography images are characterised by a strong effect called:",
     "options": ["Blooming", "Edge enhancement (fringe effect)", "Lag", "Ghosting"],
     "correct": 1, "co": "CO5"},
    {"id": 47, "question": "Film digitisation converts analogue film images to digital format using:",
     "options": ["A computed radiography plate", "A laser film scanner or digitiser", "A flat-panel DR detector", "An image intensifier"],
     "correct": 1, "co": "CO5"},
    {"id": 48, "question": "In Direct Radiography (DR), the image is captured using:",
     "options": ["Photostimulable phosphor plates", "Flat-panel detectors (FPD) — either direct or indirect conversion", "Conventional film + intensifying screens", "Image intensifier tubes"],
     "correct": 1, "co": "CO5"},
    {"id": 49, "question": "In indirect conversion flat-panel detectors, X-rays are first converted to light by:",
     "options": ["Amorphous selenium", "A scintillator material (e.g., caesium iodide or gadolinium oxysulphide)", "A photostimulable phosphor", "A lead layer"],
     "correct": 1, "co": "CO5"},
    {"id": 50, "question": "Computed Radiography (CR) plates are read by:",
     "options": ["Ultrasound transducer scanning", "A laser scanner that stimulates photoluminescence from the plate", "A magnetic reading head", "A gamma camera"],
     "correct": 1, "co": "CO5"},
    {"id": 51, "question": "The spatial resolution of a digital radiography system is mainly described by:",
     "options": ["Dynamic range", "Modulation Transfer Function (MTF) and pixel pitch/matrix size", "Detective Quantum Efficiency only", "The size of the cassette"],
     "correct": 1, "co": "CO5"},
    {"id": 52, "question": "Detective Quantum Efficiency (DQE) of a digital detector measures:",
     "options": ["How efficiently the detector converts input X-ray quanta to a useful output signal relative to an ideal detector", "The number of pixels on the detector", "The speed of image readout", "The maximum patient dose the system can measure"],
     "correct": 0, "co": "CO5"},
    {"id": 53, "question": "In CT imaging, the X-ray source and detectors rotate around the patient to produce:",
     "options": ["A single projected shadow image", "Cross-sectional (tomographic) images and 3D reconstructions", "A real-time fluoroscopic image", "A nuclear medicine scan"],
     "correct": 1, "co": "CO5"},
    {"id": 54, "question": "CT image reconstruction most commonly uses which algorithm?",
     "options": ["Fast Fourier Transform only", "Filtered back-projection (FBP) or iterative reconstruction", "Radon transform without filtering", "Maximum entropy method"],
     "correct": 1, "co": "CO5"},
    {"id": 55, "question": "A Hounsfield Unit (HU) of 0 corresponds to the attenuation of:",
     "options": ["Air", "Soft tissue", "Bone", "Water"],
     "correct": 3, "co": "CO5"},
    {"id": 56, "question": "Helical (spiral) CT differs from conventional step-and-shoot CT in that:",
     "options": ["It uses a lower tube voltage", "The table moves continuously while the X-ray tube rotates, enabling faster volume acquisition", "It does not require any radiation", "It produces only 2D images"],
     "correct": 1, "co": "CO5"},
    {"id": 57, "question": "Multi-detector CT (MDCT) improves on single-detector CT by:",
     "options": ["Eliminating all radiation dose to the patient", "Acquiring multiple slices per rotation, dramatically increasing speed and volume coverage", "Using gamma rays instead of X-rays", "Reducing image artefact to zero"],
     "correct": 1, "co": "CO5"},
    {"id": 58, "question": "The 'window width' and 'window level' in CT viewing are used to:",
     "options": ["Adjust the radiation dose retrospectively", "Optimise the display of image contrast for specific tissue types within the full HU range", "Control the speed of image reconstruction", "Set the tube current during the scan"],
     "correct": 1, "co": "CO5"},
    {"id": 59, "question": "CT Dose Index (CTDI) is used to:",
     "options": ["Measure patient blood pressure during scanning", "Characterise the radiation output of a CT scanner for dosimetry purposes", "Assess image contrast", "Calculate the number of slices per rotation"],
     "correct": 1, "co": "CO5"},
    {"id": 60, "question": "A patient presents with suspected pneumothorax. Which CT window setting would be most appropriate?",
     "options": ["Soft-tissue window (W:400, L:40)", "Lung window (W:1500, L:−600)", "Bone window (W:2000, L:400)", "Brain window (W:80, L:35)"],
     "correct": 1, "co": "CO5"},
]
